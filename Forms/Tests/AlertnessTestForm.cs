    ...
    public partial class AlertnessTestForm : BaseTestForm
    {
        ...
        public AlertnessTestForm()
        {
            ...
            instruction = "Перед Вами на экране монитора будет перемещаться по кругу, по фиксированным позициям," +
                " красное пятно. Оно будет двигаться, последовательно перемещаясь на одну позицию." +
                " Иногда красное пятно будет совершать перескок через одну позицию. " +
                "Ваша задача - внимательно следить за движением красного пятна.Если Вы заметите перескок пятна вперед" +
                " через одну позицию, то как можно быстрее нажмите на клавишу \"Пробел\"";
            label1.Visible = false;
            this.Text = "Тест на бдительность";
